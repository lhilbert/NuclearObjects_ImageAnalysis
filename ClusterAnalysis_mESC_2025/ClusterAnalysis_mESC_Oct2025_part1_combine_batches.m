%% Specify import/export parameters
% data containing the batch processing results from the cluster analysis step
sourceDirectory = fullfile(".");
sourceFiles = [ ...
    "AfterObjectAnalysis_batch01_v7.mat", ...
    "AfterObjectAnalysis_batch02_v7.mat", ...
    "AfterObjectAnalysis_batch03_v7.mat", ...
    "AfterObjectAnalysis_batch04_v7.mat", ...
    "AfterObjectAnalysis_batch05_v7.mat", ...
    "AfterObjectAnalysis_batch06_v7.mat", ...
    "AfterObjectAnalysis_batch07_v7.mat", ...
    "AfterObjectAnalysis_batch08_v7.mat", ...
    ];

save_file = "AfterObjectAnalysis_combined_v7.mat";
