%% Collect RNA polymerase II cluster features in tables
%
% This script rearranges the previously extracted RNA polymerase II cluster
% features into convenient (and space-efficient) result tables.

clear all

%% Process parameter section

% data file containing the (combined) extracted cluster features
sourceFile = fullfile(".", "NuclearClusterFeatures", "ClusterFeatures.mat");

% cluster feature table file
tablesFile = fullfile(".", "NuclearClusterFeatures", "ClusterFeatures_tables.mat");
...
clear("batch*", "cond*", "cyto_intCell", "datasetInds", "i", "j", "nDatasets", ...
    ...
    "nucleusInds", "numNuclei_vec", "perNuc*", "save_file", "sourceFile", ...
    "S2P_centCell", "S2P_eloCell", "S2P_imgCell", "S2P_intCell", "S2P_nuc*", ...
    "S2P_solCell", "S2P_volCell", "S2P_xyVoxelSizeCell", "S2P_zVoxelSizeCell", ...
    "S5P_centCell", "S5P_eloCell", "S5P_imgCell", "S5P_intCell", "S5P_nuc*", ...
    "S5P_solCell", "S5P_volCell", "S5P_xyVoxelSizeCell", "S5P_zVoxelSizeCell", ...
    "tempTable");
